...
| **Microsoft Planner** | Bidirectional task sync — Palomar assignments ↔ Planner tasks and buckets |
...
| **Copilot Studio** | Custom agent wired to Palomar MCP endpoints via Power Platform connector |
